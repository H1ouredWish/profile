...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "itzmewish@yandex.com",
    href: "mailto:itzmewish@yandex.com",
    icon: <FaEnvelope height={"50px"} />,
  },
  {
    name: "Phone",
    content: "+880 177-520-4839",
    href: "tel:01775204839",
    icon: <FaPhone height={"50px"} />,
  },
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/h1ouredwish/",
    content: "/h1oured-wish",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/H1ouredWish/",
    content: "/h1oured-wish",
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Wish, a Comp. Sci. Engineer with 1.5 year experience in Devlopment, DevOps and 
            ...
            <p className="mb-10">
              When I&apos;m not coding, you can find me in [Discord
              /Playing Games], exploring new technologies, or sipping coffee
